...
exports.updateAllUsersDomains = void 0;
...
const updateAllUsersDomains = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield user_1.default.find().select("-password").exec();
    if (!users)
        return res.status(409).json({ message: "No Users to Update." });
    users.map((user) => __awaiter(void 0, void 0, void 0, function* () {
        const ownedDomains = yield domain_1.default.find({
            username: user.username,
        }).exec();
        const userNfts = yield (0, web3Helpers_1.openseaGetUserNfts)(user.wallet);
...
exports.updateAllUsersDomains = updateAllUsersDomains;
